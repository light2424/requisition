...
form.addEventListener("submit", function (e) {
  ...
  data["Street Number"] = capitalizeFirstLetter(
    document.getElementById("street_number").value
  );
  data["Street Name"] = capitalizeFirstLetter(
    document.getElementById("street_name").value
  );
  data["Unit Number"] = capitalizeFirstLetter(
    document.getElementById("unit_number").value
  );
  data["PO Box"] = capitalizeFirstLetter(
  ...
  data["Email Address"] = capitalizeFirstLetter(
